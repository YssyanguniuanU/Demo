        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    ...
                    <li class="profile_tab_line">|</li>
                    <li><a href="passwordChange.jsp">密码安全</a></li>
                </ul>
                            ...
                            <form action="userUpdate">
                                ...
                                <div class="form_group">
                                    ...
                                    <c:if test="${user.sex == '男' }">
                                    	<input id="man"  type="radio" checked="checked" name="sex" value="男"><label for="man" >男</label>
									...
									<c:if test="${user.sex == '女' }">
                                    	...
                                    	<input id="woman" type="radio" checked="checked" name="sex" value="女"><label for="woman">女</label>
                                    </c:if>
