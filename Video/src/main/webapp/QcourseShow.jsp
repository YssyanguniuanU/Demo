...
<script type="text/javascript">
	function getVideo(videooId,courseId){
		var urlh = "videooId="+videooId+"&courseId="+courseId
		var url = "getVideoList?"+urlh;
		location.href=url
	}
</script>
</head>
...
<header>
    ...
    <div id="app">
        ...
        <!--面包屑导航-->
        <div class="container mian-nav" id="navDiv"><a href="index.jsp" style="color:blue">公开课</a> / ${subjectN.subjectName }</div>
		
		<c:forEach items="${cavList }" var="subject">
