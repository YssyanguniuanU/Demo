...
<script type="text/javascript">
	...
	function change(){
		document.getElementById("speakerId")[${videoo.speakerId-1}].selected=true;
		document.getElementById("courseId")[${videoo.courseId-1}].selected=true;
	}
</script>
...
<body>
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal" action="videooUpdate" method="post" >
			<input type="hidden" name="videooId" value="${videoo.videooId }"/>
			<div class="form-group">
			    <label for="subjectId" class="col-sm-2 control-label">视频标题</label>
			    <div class="col-sm-10">
					<input class="form-control" name="title" id="title" placeholder="视频标题" type="text" value="${videoo.title }">
			    </div>
			 </div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="time" id="time" placeholder="视频时长" type="text" value="${videoo.time }">
				</div>
			</div>
			<div class="form-group">
				<label for="courseDesc" class="col-sm-2 control-label">视频播放地址</label>
				<div class="col-sm-10">
					<input class="form-control" name="videoUrl" id="videoUrl" placeholder="视频播放地址" type="text" value="${videoo.videoUrl }">
				</div>
			</div>
			<div class="form-group">
				<label for="courseDesc" class="col-sm-2 control-label">封面图片地址</label>
				<div class="col-sm-10">
					<input class="form-control" name="imageUrl" id="imageUrl" placeholder="封面图片地址" type="text" value="${videoo.imageUrl }">
				</div>
			</div>
			<div class="form-group">
				<label for="courseDesc" class="col-sm-2 control-label">视频详情介绍</label>
				<div class="col-sm-10">
					<input class="form-control" name="detail" id="detail" placeholder="视频信息介绍" type="text" value="${videoo.detail }">
				</div>
			</div>
			<div class="form-group">
